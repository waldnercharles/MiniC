...
#define HRESULT_IS_WIN32(x) ((((x) >> 16) & 0xFFFF) == 0x8)
#define HRESULT_IS_FAILURE(x) ((((x) >> 31) & 0x1) == 0x1)
#define HRESULT_FACILITY(x) (((x) >> 16) & 0xFFFF)
...
/* Bit Operations */
char _InterlockedExchangeAnd8(char volatile *Destination, char Value);
char _InterlockedExchangeOr8(char volatile *Destination, char Value);
char _InterlockedExchangeXor8(char volatile *Destination, char Value);

/* Increment & Decrement */
char _InterlockedDecrement8(char volatile *Addend);
...
char _InterlockedCompareExchange8(char volatile *Destination,
                                  char Exchange,
                                  char Comparand);
char _InterlockedCompareExchange8_HLEAcquire(char volatile *Destination,
                                             char Exchange,
                                             char Comparand);
char _InterlockedCompareExchange8_HLERelease(char volatile *Destination,
                                             char Exchange,
                                             char Comparand);
...
/* Bit Operations */
short _InterlockedExchangeAnd16(short volatile *Destination, short Value);
short _InterlockedExchangeOr16(short volatile *Destination, short Value);
short _InterlockedExchangeXor16(short volatile *Destination, short Value);
...
short _InterlockedCompareExchange16(short volatile *Destination,
                                    short Exchange,
                                    short Comparand);
short _InterlockedCompareExchange16_HLEAcquire(short volatile *Destination,
                                               short Exchange,
                                               short Comparand);
short _InterlockedCompareExchange16_HLERelease(short volatile *Destination,
                                               short Exchange,
                                               short Comparand);
...
/* Bit Operations */
long _InterlockedExchangeAnd(long volatile *Destination, long Value);
long _InterlockedExchangeOr(long volatile *Destination, long Value);
long _InterlockedExchangeXor(long volatile *Destination, long Value);
...
long _InterlockedCompareExchange(long volatile *Destination,
                                 long Exchange,
                                 long Comparand);
long _InterlockedCompareExchange_HLEAcquire(long volatile *Destination,
                                            long Exchange,
                                            long Comparand);
long _InterlockedCompareExchange_HLERelease(long volatile *Destination,
                                            long Exchange,
                                            long Comparand);
...
/* Bit Operations */
__int64 _InterlockedExchangeAnd64(__int64 volatile *Destination, __int64 Value);
__int64 _InterlockedExchangeOr64(__int64 volatile *Destination, __int64 Value);
__int64 _InterlockedExchangeXor64(__int64 volatile *Destination, __int64 Value);
...
/* Exchange */
unsigned char _InterlockedCompareExchange128(__int64 volatile *Destination,
...
BOOL WINAPI CheckRemoteDebuggerPresent(HANDLE hProcess,
...
typedef BOOL (*PSYM_ENUMERATESYMBOLS_CALLBACK)(PSYMBOL_INFO pSymInfo,
                                               ULONG SymbolSize,
                                               PVOID UserContext);
typedef BOOL (*PSYM_ENUMERATESYMBOLS_CALLBACKW)(PSYMBOL_INFOW pSymInfo,
                                                ULONG SymbolSize,
                                                PVOID UserContext);
...
typedef BOOL (*PSYM_ENUMMODULES_CALLBACK64)(LPCSTR ModuleName,
                                            DWORD64 BaseOfDll,
                                            PVOID UserContext);
typedef BOOL (*PSYM_ENUMMODULES_CALLBACKW64)(LPCWSTR ModuleName,
                                             DWORD64 BaseOfDll,
                                             PVOID UserContext);
BOOL WINAPI
...
BOOL WINAPI SymSetSearchPath(HANDLE hProcess, LPCSTR SearchPath);
BOOL WINAPI SymSetSearchPathW(HANDLE hProcess, LPCWSTR SearchPath);
...
PVOID WINAPI
AddVectoredExceptionHandler(ULONG FirstHandler,
...
DWORD WINAPI GetModuleFileNameExW(HANDLE hProcess,
                                  ...
                                  LPWSTR lpFileName,
                                  DWORD nSize);
HANDLE WINAPI OpenFileMappingA(DWORD dwDesiredAccess,
                               BOOL bInheritHandle,
                               LPCSTR lpName);
HANDLE WINAPI OpenFileMappingW(DWORD dwDesiredAccess,
                               BOOL bInheritHandle,
                               LPCWSTR lpName);
...
BOOL WINAPI CopyFileA(LPCSTR lpExistingFileName,
                      ...
                      BOOL bFailIfExists);
BOOL WINAPI CopyFileW(LPCWSTR lpExistingFileName,
...
BOOL WINAPI MoveFileExA(LPCSTR lpExistingFileName,
                        LPCSTR lpNewFileName,
                        DWORD dwFlags);
BOOL WINAPI MoveFileExW(LPCWSTR lpExistingFileName,
                        LPCWSTR lpNewFileName,
                        DWORD dwFlags);
...
/* ========================================================================== */
/* Temp File: */
UINT WINAPI GetTempFileNameW(LPCWSTR lpPathName,
...
LPVOID WINAPI HeapReAlloc(HANDLE hHeap,
                          DWORD dwFlags,
                          LPVOID lpMem,
                          SIZE_T dwBytes);
...
LPVOID WINAPI VirtualAlloc(LPVOID lpAddress,
                           ...
                           DWORD flProtect);
SIZE_T WINAPI VirtualQuery(LPCVOID lpAddress,
...
BOOL WINAPI FlushInstructionCache(HANDLE hProcess,
...
/* ========================================================================== */
/* Path Functions: */
DWORD WINAPI GetFullPathNameA(LPCSTR lpFileName,
                              DWORD nBufferLength,
                              LPSTR lpBuffer,
                              LPSTR *lpFilePart);
DWORD WINAPI GetFullPathNameW(LPCWSTR lpFileName,
                              DWORD nBufferLength,
                              LPWSTR lpBuffer,
                              LPWSTR *lpFilePart);
...
#define _byteswap_ulong(x)                                                     \
    (((unsigned long)(x) << 24) | (((unsigned long)(x) << 8) & 0xff0000) |     \
     (((unsigned long)(x) >> 8) & 0xff00) | ((unsigned long)(x) >> 24))
...
LPCSTR WINAPI lstrcpyA(LPCSTR lpString1, LPCSTR lpString2);
LPCWSTR WINAPI lstrcpyW(LPCWSTR lpString1, LPCWSTR lpString2);

/* ========================================================================== */
/* Time: */
void WINAPI GetSystemTime(LPSYSTEMTIME lpSystemTime);
void WINAPI GetLocalTime(LPSYSTEMTIME lpSystemTime);
BOOL WINAPI QueryProcessCycleTime(HANDLE hProcess, PULONG64 CycleTime);
BOOL WINAPI SystemTimeToFileTime(const SYSTEMTIME *lpSystemTime,
                                 LPFILETIME lpFileTime);
BOOL WINAPI FileTimeToSystemTime(const FILETIME *lpFileTime,
                                 LPSYSTEMTIME lpSystemTime);
void WINAPI GetSystemTimeAsFileTime(LPFILETIME lpSystemTimeAsFileTime);
BOOL WINAPI SystemTimeToTzSpecificLocalTime(LPTIME_ZONE_INFORMATION lpTimeZone,
...
DWORD WINAPI GetEnvironmentVariableA(LPCSTR lpName,
                                     LPCSTR lpBuffer,
                                     DWORD nSize);
DWORD WINAPI GetEnvironmentVariableW(LPCWSTR lpName,
                                     LPCWSTR lpBuffer,
                                     DWORD nSize);
...
/* ========================================================================== */
/* Jobs: */
HANDLE WINAPI CreateJobObjectA(LPSECURITY_ATTRIBUTES lpJobAttributes,
                               LPCSTR lpName);
HANDLE WINAPI CreateJobObjectW(LPSECURITY_ATTRIBUTES lpJobAttributes,
                               LPCWSTR lpName);
...
/* Version: */
BOOL WINAPI VerifyVersionInfoA(LPOSVERSIONINFOEXA lpVersionInfo,
                               DWORD dwTypeMask,
                               DWORDLONG dwlConditionMask);
BOOL WINAPI VerifyVersionInfoW(LPOSVERSIONINFOEXW lpVersionInfo,
                               DWORD dwTypeMask,
                               DWORDLONG dwlConditionMask);
ULONGLONG WINAPI VerSetConditionMask(ULONGLONG ConditionMask,
                                     DWORD TypeMask,
                                     BYTE Condition);
...
IsWindowsVersionOrGreater(WORD major, WORD minor, WORD servpack)
{
    ...
    return VerifyVersionInfoW(
        ...
        VerSetConditionMask(
            VerSetConditionMask(VerSetConditionMask(0,
                                                    VER_MAJORVERSION,
                                                    VER_GREATER_EQUAL),
                                VER_MINORVERSION,
                                VER_GREATER_EQUAL),
...
/* ========================================================================== */
/* Registry: */
LONG WINAPI RegOpenKeyExA(HKEY hKey,
                          LPCSTR lpSubKey,
                          DWORD ulOptions,
                          REGSAM samDesired,
                          PHKEY phkResult);
LONG WINAPI RegOpenKeyExW(HKEY hKey,
                          ...
                          REGSAM samDesired,
                          PHKEY phkResult);
LONG WINAPI RegQueryValueExA(HKEY hKey,
                             LPCSTR lpValueName,
                             LPDWORD lpReserved,
                             LPDWORD lpType,
                             LPBYTE lpData,
                             LPDWORD lpcbData);
LONG WINAPI RegQueryValueExW(HKEY hKey,
                             LPCWSTR lpValueName,
                             LPDWORD lpReserved,
                             LPDWORD lpType,
                             LPBYTE lpData,
                             LPDWORD lpcbData);
LONG WINAPI RegCreateKeyExA(HKEY hKey,
                            LPCSTR lpSubKey,
                            DWORD Reserved,
                            LPSTR lpClass,
                            DWORD dwOptions,
...
LONG WINAPI RegCreateKeyExW(HKEY hKey,
                            LPCWSTR lpSubKey,
                            DWORD Reserved,
                            LPWSTR lpClass,
                            DWORD dwOptions,
                            ...
                            PHKEY phkResult,
                            LPDWORD lpdwDisposition);
LONG WINAPI RegEnumValueA(HKEY hKey,
                          DWORD dwIndex,
                          LPSTR lpValueName,
                          ...
                          LPBYTE lpData,
                          LPDWORD lpcbData);
LONG WINAPI RegEnumValueW(HKEY hKey,
                          DWORD dwIndex,
                          LPWSTR lpValueName,
                          LPDWORD lpcchValueName,
                          LPDWORD lpReserved,
...
LONG WINAPI RegQueryInfoKeyW(HKEY hKey,
                             ...
                             LPDWORD lpcbSecurityDescriptor,
                             PFILETIME lpftLastWriteTime);
LONG WINAPI RegEnumKeyExA(HKEY hKey,
                          DWORD dwIndex,
                          LPSTR lpName,
                          LPDWORD lpcName,
                          LPDWORD lpReserved,
                          ...
                          LPDWORD lpcClass,
                          PFILETIME lpftLastWriteTime);
LONG WINAPI RegEnumKeyExW(HKEY hKey,
                          DWORD dwIndex,
                          LPWSTR lpName,
                          LPDWORD lpcName,
                          LPDWORD lpReserved,
...
DWORD WINAPI WaitForSingleObjectEx(HANDLE hHandle,
                                   DWORD dwMilliseconds,
                                   BOOL bAlertable);
DWORD WINAPI WaitForMultipleObjectsEx(DWORD nCount,
                                      const HANDLE *lpHandles,
                                      BOOL bWaitAll,
                                      DWORD dwMilliseconds,
                                      BOOL bAlertable);
...
InitializeCriticalSectionAndSpinCount(LPCRITICAL_SECTION lpCriticalSection,
                                      DWORD dwSpinCount);
DWORD WINAPI SetCriticalSectionSpinCount(LPCRITICAL_SECTION lpCriticalSection,
                                         DWORD dwSpinCount);
...
HANDLE WINAPI OpenSemaphoreA(DWORD dwDesiredAccess,
                             BOOL bInheritHandle,
                             LPCSTR lpName);
HANDLE WINAPI OpenSemaphoreW(DWORD dwDesiredAccess,
                             BOOL bInheritHandle,
                             LPCWSTR lpName);
...
DWORD WINAPI TlsFree(DWORD dwTlsIndex);
...
/* ========================================================================== */
/* Waiting: */
BOOL WINAPI WaitOnAddress(void volatile *Address,
...
int WINAPI MessageBoxW(HWND hWND,
                       ...
                       LPCWSTR lpCaption,
                       UINT uType);
ATOM WINAPI RegisterClassA(WNDCLASS *lpWndClass);
ATOM WINAPI RegisterClassW(WNDCLASS *lpWndClass);
...
HANDLE WINAPI CreateEventA(LPSECURITY_ATTRIBUTES lpEventAttributes,
                           ...
                           BOOL bInitialState,
                           LPCSTR lpName);
HANDLE WINAPI CreateEventW(LPSECURITY_ATTRIBUTES lpEventAttributes,
                           BOOL bManualReset,
                           BOOL bInitialState,
                           LPCWSTR lpName);
HANDLE WINAPI OpenEventA(DWORD dwDesiredAccess,
                         BOOL bInheritHandle,
                         LPCSTR lpName);
HANDLE WINAPI OpenEventW(DWORD dwDesiredAccess,
                         BOOL bInheritHandle,
                         LPCWSTR lpName);
BOOL WINAPI ResetEvent(HANDLE hEvent);
BOOL WINAPI SetEvent(HANDLE hEvent);
